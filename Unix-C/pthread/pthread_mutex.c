 ...
 * @LastEditTime: 2020-06-08 19:06:07
...
void *thread_fun1( void *arg )
{
    ...
    printf( "start thread 1, f_count:%d\n",tp->f_count );
    foo_hold( tp );
    tp->data+=1;
    foo_rele( tp );
...
{
    struct foo *tp = (struct foo *)arg;
    printf( "start thread 2, f_count:%d\n",tp->f_count );
    foo_hold( tp );
    tp->data+=1;
    foo_rele( tp );
...
{
    struct foo *tp = (struct foo *)arg;
    printf( "start thread 3, f_count:%d\n",tp->f_count );
    foo_hold( tp );
    tp->data+=1;
    foo_rele( tp );
...
{
    struct foo *tp = (struct foo *)arg;
    printf( "start thread 4, f_count:%d\n",tp->f_count );
    foo_hold( tp );
    tp->data+=1;
    foo_rele( tp );
...
{
    struct foo *tp = (struct foo *)arg;
    printf( "start thread 5, f_count:%d\n",tp->f_count );
    foo_hold( tp );
    tp->data+=1;
    foo_rele( tp );
